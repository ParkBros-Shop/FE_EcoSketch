...
const Header = () => {
    ...
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        ...
        <li>
          <a>원두</a>
          <ul className="p-1">
            <Link to="/product200g"><li><a>200g</a></li></Link>
            <Link to="/product500g"><li><a>500g</a></li></Link>
            <Link to="/product1kg"><li><a>1kg</a></li></Link>
          </ul>
        </li>
        <li><a>공지사항</a></li>
      </ul>
  ...
  <div className="navbar-end text-xl">
          ...
          <Link to="/member/login"className="ml-3 bg-transparent border-none">로그인</Link>
  </div>
</div>
    </header>
  );
